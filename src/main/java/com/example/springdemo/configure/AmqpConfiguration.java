package com.example.springdemo.configure;
...
public class AmqpConfiguration {
    ...
    public Binding directBinding1(){
        return BindingBuilder.bind(routingQueue1()).to(directExchange()).with("goods");
    }
    @Bean
    ...
    public Binding topicBinding1(){
        return BindingBuilder.bind(topicQueue1()).to(topicExchange()).with("goods.add");
    }
    @Bean
